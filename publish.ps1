...
if ($Target.Equals("Debug")) {
    ...
    Copy-Item -Path "$ProjectPath\PrePackage\Translations" -Destination "$PluginPath\" -Recurse -Force
}
...
if($Target.Equals("Release")) {
    ...
    Copy-Item -Path "$ProjectPath\Prepackage\Translations" -Destination "$PackagePluginsPath\" -Recurse -Force
    Copy-Item -Path "$ProjectPath\README.md" -Destination "$PackagePath\" -Force
